...
def fetch_poster(movie_id):
    url ="https://api.themoviedb.org/3/movie/{}?api_key=5c7ab098ec4c07f8366f0f8efd688cdblanguage=en-US".format(movie_id)
...
st.header("Movie Recommendation System ML")
movies = pickle.load(open('artificats/movie_list.pkl','rb'))
similarity = pickle.load(open('artificats/msimilarity.pkl','rb'))
